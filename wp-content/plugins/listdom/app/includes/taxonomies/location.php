...
class LSD_Taxonomies_Location extends LSD_Taxonomies
{
    ...
    {
        $singular = lsd_t_label(LSD_Base::TAX_LOCATION, 'singular');
        $plural = lsd_t_label(LSD_Base::TAX_LOCATION, 'plural');
        $singular_lc = lsd_t_label_lc(LSD_Base::TAX_LOCATION, 'singular');
        $plural_lc = lsd_t_label_lc(LSD_Base::TAX_LOCATION, 'plural');

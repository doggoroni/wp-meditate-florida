...
<div class="lsd-settings-wrap" id="lsd_settings_frontend_dashboard">
    <form id="lsd_settings_form">
        <div id="lsd_panel_frontend-dashboard_general" class="lsd-settings-form-group lsd-tab-content<?php echo $this->subtab === 'general' || !$this->subtab ? ' lsd-tab-content-active' : ''; ?>">
            <h3 class="lsd-admin-title lsd-mt-0"><?php esc_html_e('General', 'listdom'); ?></h3>
            <div class="lsd-settings-group-wrapper">
                <div class="lsd-settings-fields-wrapper">
                    ...
                    <div class="lsd-form-row<?php echo (isset($settings['dashboard_menu_sidebar_status']) && $settings['dashboard_menu_sidebar_status'] === 'horizontal') ? '' : ' lsd-util-hide'; ?>" id="lsd_settings_dashboard_menu_sidebar_horizontal_wrapper">
                        <div class="lsd-col-3"><?php echo LSD_Form::label([
                            'class' => 'lsd-fields-label',
                ...
                <div class="lsd-settings-fields-wrapper">
                    ...
                    <div class="lsd-form-row<?php echo empty($settings['dashboard_listing_status']) ? ' lsd-util-hide' : ''; ?>" id="lsd_settings_dashboard_listing_status_guest_row">
                        <div class="lsd-col-3"><?php echo LSD_Form::label([
                            'class' => 'lsd-fields-label',
                            ...
                            <ul class="lsd-settings-dashboard-menus lsd-mt-0">
                                ...
                                foreach ($ordered_items as $item)
                                {
                                    ...
                                    if ($item['type'] === 'builtin')
                                    {
                                        ...
                                        ?>
                                        <li class="lsd-dashboard-menu-item<?php echo esc_attr($disabled_class); ?>" id="<?php echo esc_attr($id); ?>">
                                            <p class="lsd-flex lsd-flex-content-between">
                                                <span>
                                                    ...
                                                    <span class="lsd-dashboard-menu-default-label">(<?php echo esc_html($default_label); ?>)</span>
                                                    <?php endif; ?>
                                                </span>
                                                <span class="lsd-menu-actions">
                                                    <button type="button" class="lsd-dashboard-menu-toggle" aria-pressed="<?php echo $enabled ? 'true' : 'false'; ?>">
                                            ...
                                            <div class="lsd-dashboard-menu-content lsd-util-hide">
                                                <div class="lsd-field-group">
                                                    <label class="lsd-fields-label-tiny" for="lsd_builtin_menu_<?php echo esc_attr($key); ?>_label">
                                                ...
                                                <div class="lsd-field-group">
                                                    <label class="lsd-fields-label-tiny" for="lsd_builtin_menu_<?php echo esc_attr($key); ?>_icon">
                                                        <?php esc_html_e('Icon', 'listdom'); ?>
                                                    </label>
                                                    <?php echo LSD_Kses::form($icon_picker); ?>
                                                </div>
                                            </div>
                                            <input type="hidden" name="lsd[dashboard_menus][]" value="<?php echo esc_attr($id); ?>">
                                            <input type="hidden" class="lsd-dashboard-menu-status" name="lsd[dashboard_menu_builtin_status][<?php echo esc_attr($key); ?>]" value="<?php echo esc_attr($enabled_value); ?>">
                                        </li>
                                        <?php
                                        continue;
                                    }
                                    ...
                                    <li class="lsd-dashboard-menu-item lsd-custom-menu-list<?php echo esc_attr($disabled_class); ?>">
                                        <p class="lsd-flex lsd-flex-content-between">
                                            ...
                                            <span class="lsd-menu-actions">
                                                ...
                                                <button type="button" class="lsd-dashboard-menu-toggle" aria-pressed="<?php echo $enabled ? 'true' : 'false'; ?>"><i class="fas <?php echo esc_attr($toggle_icon); ?>"></i></button>
                                                <i class="fas fa-chevron-down lsd-dashboard-menu-chevron"></i>
                                            </span>
                                        </p>
                                        <div class="lsd-custom-menu-content lsd-dashboard-menu-content lsd-util-hide">
                                            ...
                                            <div class="lsd-field-group">
                                                <label class="lsd-fields-label-tiny" for="<?php echo $base_id; ?>_login_status">

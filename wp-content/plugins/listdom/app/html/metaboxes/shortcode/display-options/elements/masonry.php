            ...
            <div class="lsd-elements-section">
                <?php if ($this->isPro()): ?>
                    <div class="lsd-elements-subsection">
                        ...
                        <div class="lsd-elements-fields lsd-elements-3-column">
                            ...
                            <div class="lsd-image-row lsd-display-options-skin-masonry-image-options <?php echo !isset($masonry['display_image']) || $masonry['display_image'] ? '' : 'lsd-util-hide'; ?>">
                                <div><?php echo LSD_Form::label([
                                        'class' => 'lsd-fields-label',
                ...
                <div class="lsd-elements-subsection lsd-display-options-style-dependency lsd-display-options-style-dependency-style3">
                    ...
                    <div class="lsd-elements-fields lsd-elements-3-column">
                        ...
                        <div class="lsd-content-row <?php echo !isset($masonry['display_description']) || $masonry['display_description'] ? '' : 'lsd-util-hide'; ?>" id="lsd_display_options_skin_masonry_description_length_wrapper">
                                <div><?php echo LSD_Form::label([
                                        'class' => 'lsd-fields-label',
                        ...
                        <div class="lsd-content-row <?php echo !isset($masonry['display_description']) || $masonry['display_description'] ? '' : 'lsd-util-hide'; ?>" id="lsd_display_options_skin_masonry_content_type_wrapper">
                                <div><?php echo LSD_Form::label([
                                        'class' => 'lsd-fields-label',

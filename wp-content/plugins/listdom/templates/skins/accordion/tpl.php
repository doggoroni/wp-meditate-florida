...
{
    jQuery("#lsd_skin'.$this->id.'").listdomAccordionSkin(
    {
        id: "'.$this->id.'",
...
?>
<div class="lsd-skin-wrapper lsd-accordion-view-wrapper <?php echo sanitize_html_class($this->get_bar_class()); ?> <?php echo esc_attr($this->html_class); ?> lsd-style-<?php echo esc_attr($this->style); ?> lsd-font-m" id="lsd_skin<?php echo esc_attr($this->id); ?>" data-next-page="<?php echo esc_attr($this->next_page); ?>">
    ...
    <div class="lsd-skin-main-bar-wrapper">
        ...
        <div class="lsd-list-wrapper">
            <?php
                /**
                 * Top Position of Accordion View
                 */
                if ($this->map_provider && $this->map_position === 'top')
                {
                    echo '<div class="lsd-accordion-view-top-wrapper">';
                    echo $this->get_map();
                    echo '</div>';
                }
            ?>
            ...
            <div class="lsd-accordion-view-listings-wrapper lsd-viewstyle-accordion">
            ...
            <?php
                /**
                 * Bottom Position of Accordion View
                 */
                if ($this->map_provider && $this->map_position === 'bottom')
                {
                    echo '<div class="lsd-accordion-view-bottom-wrapper">';
                    echo $this->get_map();
                    echo '</div>';
                }
            ?>

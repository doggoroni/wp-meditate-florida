...
$mapobject_onclick = $gallery['mapobject_onclick'] ?? 'infowindow';
$infowindow_trigger = $gallery['mapobject_infowindow_trigger'] ?? 'click';
?>
    ...
    <div class="lsd-settings-fields-wrapper">
        ...
        <div class="lsd-form-row">
            <div class="lsd-col-3"><?php echo LSD_Form::label([
                ...
                'for' => 'lsd_display_options_skin_gallery_map_provider',
            ]); ?></div>
            <div class="lsd-col-7">
                <?php echo LSD_Form::providers([
                    'id' => 'lsd_display_options_skin_gallery_map_provider',
                    'name' => 'lsd[display][gallery][map_provider]',
                    'value' => $gallery['map_provider'] ?? LSD_Map_Provider::def(),
                    'disabled' => true,
                    'class' => 'lsd-map-provider-toggle lsd-admin-input',
                    'attributes' => [
                        'data-parent' => '#lsd_skin_display_options_map_gallery'
                    ]
                ]); ?>
            </div>
        </div>
        <div class="lsd-settings-fields-sub-wrapper lsd_display_options_skin_gallery_map_options lsd-form-group lsd-form-row-map-needed lsd-p-0 lsd-m-0 <?php echo isset($gallery['map_provider']) && $gallery['map_provider'] ? '' : 'lsd-util-hide'; ?>">
            <div class="lsd-form-row">
                <div class="lsd-col-3"><?php echo LSD_Form::label([
                    'class' => 'lsd-fields-label',
                    'title' => esc_html__('Position', 'listdom'),
                    'for' => 'lsd_display_options_skin_gallery_map_position',
                ]); ?></div>
                <div class="lsd-col-7">
                    <?php echo LSD_Form::select([
                        'class' => 'lsd-admin-input',
                        'id' => 'lsd_display_options_skin_gallery_map_position',
                        'name' => 'lsd[display][gallery][map_position]',
                        'options' => [
                            'top' => esc_html__('Show before the Gallery view', 'listdom'),
                            'bottom' => esc_html__('Show after the Gallery view', 'listdom'),
                            'left' => esc_html__('Show on left', 'listdom'),
                            'right' => esc_html__('Show on right', 'listdom')
                        ],
                        'value' => $gallery['map_position'] ?? 'top'
                    ]); ?>
                </div>
            </div>
            <div class="lsd-form-row lsd-map-provider-dependency lsd-map-provider-dependency-googlemap">
                <div class="lsd-col-3"><?php echo LSD_Form::label([
                    ...
                    'for' => 'lsd_display_options_skin_gallery_mapstyle',
                ]); ?></div>
                <div class="lsd-col-7">
                    <?php echo LSD_Form::mapstyle([
                        'class' => 'lsd-admin-input',
                        'id' => 'lsd_display_options_skin_gallery_mapstyle',
                        'name' => 'lsd[display][gallery][mapstyle]',
                        'value' => $gallery['mapstyle'] ?? ''
                    ]); ?>
                </div>
            </div>
            <div class="lsd-form-row">
                <div class="lsd-col-3"><?php echo LSD_Form::label([
                        ...
                        'for' => 'lsd_display_options_skin_gallery_map_height',
                    ]); ?></div>
                <div class="lsd-col-7">
                    <?php echo LSD_Form::text([
                        'class' => 'lsd-admin-input',
                        'id' => 'lsd_display_options_skin_gallery_map_height',
                        'name' => 'lsd[display][gallery][map_height]',
                        'value' => $gallery['map_height'] ?? ''
                    ]); ?>
            ...
            <div class="lsd-form-row">
                <div class="lsd-col-3"><?php echo LSD_Form::label([
                        ...
                        'for' => 'lsd_display_options_skin_gallery_mousewheel_zoom',
                    ]); ?></div>
                <div class="lsd-col-7">
                    <?php echo LSD_Form::select([
                        'class' => 'lsd-admin-input',
                        'id' => 'lsd_display_options_skin_gallery_mousewheel_zoom',
                        'name' => 'lsd[display][gallery][mousewheel_zoom]',
                        'options' => [
                            '0' => esc_html__('Disabled', 'listdom'),
                            '1' => esc_html__('Enabled', 'listdom'),
                        ],
                        'value' => $gallery['mousewheel_zoom'] ?? '0',
                    ]); ?>
            ...
            do_action('lsd_shortcode_kml_layers_map_options', 'gallery', $options);
            ?>
        </div>
    </div>

    <div class="lsd_display_options_skin_gallery_map_options lsd-settings-group-wrapper lsd-form-group lsd-form-row-map-needed lsd-p-0 lsd-m-0 <?php echo isset($gallery['map_provider']) && $gallery['map_provider'] ? '' : 'lsd-util-hide'; ?>">
        <div class="lsd-settings-fields-wrapper">
            ...
            <div class="lsd-form-row">
                <div class="lsd-col-3"><?php echo LSD_Form::label([
                    ...
                    'for' => 'lsd_display_options_skin_gallery_mapobject_onclick',
                ]); ?></div>
                <div class="lsd-col-7">
                    <?php echo LSD_Form::select([
                        'class' => 'lsd-admin-input lsd-trigger-select-options',
                        'id' => 'lsd_display_options_skin_gallery_mapobject_onclick',
                        'name' => 'lsd[display][gallery][mapobject_onclick]',
                        'options' => [
                            'infowindow' => [
                                'label' => esc_html__('Open Infowindow', 'listdom'),
                                'attributes' => [
                                    'data-lsd-show' => '#lsd_display_options_skin_gallery_infowindow_trigger',
                                ],
                            ],
                            'redirect' => [
                                'label' => esc_html__('Redirect to Single Listing Page', 'listdom'),
                                'attributes' => [
                                    'data-lsd-hide' => '#lsd_display_options_skin_gallery_infowindow_trigger',
                                ],
                            ],
                            'lightbox' => [
            ...
            <div class="lsd-form-row <?php echo $mapobject_onclick === 'infowindow' ? '' : 'lsd-util-hide'; ?>" id="lsd_display_options_skin_gallery_infowindow_trigger">
                <div class="lsd-col-3"><?php echo LSD_Form::label([
                    'class' => 'lsd-fields-label',
                    'title' => esc_html__('Info Window Trigger', 'listdom'),
                    'for' => 'lsd_display_options_skin_gallery_infowindow_trigger_select',
                ]); ?></div>
                <div class="lsd-col-7">
                    <?php echo LSD_Form::select([
                        'class' => 'lsd-admin-input',
                        'id' => 'lsd_display_options_skin_gallery_infowindow_trigger_select',
                        'name' => 'lsd[display][gallery][mapobject_infowindow_trigger]',
                        'options' => [
            ...
            do_action('lsd_shortcode_map_options', 'gallery', $options);
            ?>
        </div>
        ...
        <div class="lsd-settings-fields-wrapper">
            ...
            <div class="lsd-form-row lsd-flex-align-items-center">
                <div class="lsd-col-3"><?php echo LSD_Form::label([
                    ...
                    'for' => 'lsd_display_options_skin_gallery_clustering',
                ]); ?></div>
                <div class="lsd-col-7">
                    <?php echo LSD_Form::switcher([
                        'id' => 'lsd_display_options_skin_gallery_clustering',
                        'toggle' => '#lsd_display_options_skin_gallery_clustering_options',
                        'name' => 'lsd[display][gallery][clustering]',
                        'value' => $gallery['clustering'] ?? '1'
                    ]); ?>
                </div>
            </div>
            <div class="lsd-map-provider-dependency lsd-map-provider-dependency-googlemap">
                <div id="lsd_display_options_skin_gallery_clustering_options" <?php echo !isset($gallery['clustering']) || $gallery['clustering'] ? '' : 'style="display: none;"'; ?>>
                    <div class="lsd-form-row">
                        <div class="lsd-col-3"><?php echo LSD_Form::label([
                            'class' => 'lsd-fields-label',
                            'title' => esc_html__('Bubbles', 'listdom'),
                            'for' => 'lsd_display_options_skin_gallery_clustering_images',
                        ]); ?></div>
                        <div class="lsd-col-7">
                            <?php echo LSD_Form::select([
                                'class' => 'lsd-admin-input',
                                'id' => 'lsd_display_options_skin_gallery_clustering_images',
                                'name' => 'lsd[display][gallery][clustering_images]',
                                'options' => LSD_Base::get_clustering_icons(),
                                'value' => $gallery['clustering_images'] ?? 'img/cluster1/m'
                            ]); ?>
                        </div>
                    </div>
                </div>
        ...
        <div class="lsd-settings-fields-wrapper">
            ...
            <div class="lsd-form-row lsd-flex-align-items-center lsd-map-provider-dependency lsd-map-provider-dependency-googlemap lsd-map-provider-dependency-leaflet">
                <div class="lsd-col-3"><?php echo LSD_Form::label([
                    ...
                    'for' => 'lsd_display_options_skin_gallery_mapsearch',
                ]); ?></div>
                <div class="lsd-col-7">
                    <?php if ($this->isPro()): ?>
                        <?php echo LSD_Form::switcher([
                            'id' => 'lsd_display_options_skin_gallery_mapsearch',
                            'name' => 'lsd[display][gallery][mapsearch]',
                            'value' => $gallery['mapsearch'] ?? '1',
                        ]); ?>
                    <?php else: ?>
            ...
            <?php
            // Action for Third Party Plugins
            do_action('lsd_shortcode_auto_gps_map_options', 'gallery', $options);
            ?>
        </div>
        ...
        <div class="lsd-settings-fields-wrapper">
            ...
            <div class="lsd-form-row">
                <div class="lsd-col-3"><?php echo LSD_Form::label([
                    ...
                    'for' => 'lsd_display_options_skin_gallery_maplimit',
                ]); ?></div>
                <div class="lsd-col-7">
                    <?php echo LSD_Form::text([
                        'class' => 'lsd-admin-input',
                        'id' => 'lsd_display_options_skin_gallery_maplimit',
                        'name' => 'lsd[display][gallery][maplimit]',
                        'value' => $gallery['maplimit'] ?? '300'
                    ]); ?>
            ...
            <?php
            // Action for Third Party Plugins
            do_action('lsd_shortcode_restrictions_map_options', 'gallery', $options);
            ?>

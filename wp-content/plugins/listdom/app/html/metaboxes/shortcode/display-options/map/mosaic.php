...
$mapobject_onclick = $mosaic['mapobject_onclick'] ?? 'infowindow';
$infowindow_trigger = $mosaic['mapobject_infowindow_trigger'] ?? 'click';
?>
...
<div class="lsd-settings-group-wrapper">
        ...
        <div class="lsd-settings-fields-sub-wrapper lsd_display_options_skin_mosaic_map_options lsd-form-group lsd-form-row-map-needed lsd-p-0 lsd-m-0 <?php echo isset($mosaic['map_provider']) && $mosaic['map_provider'] ? '' : 'lsd-util-hide'; ?>">
            ...
            <div class="lsd-form-row">
                <div class="lsd-col-3"><?php echo LSD_Form::label([
                        ...
                        'for' => 'lsd_display_options_skin_mosaic_mousewheel_zoom',
                    ]); ?></div>
                <div class="lsd-col-7">
                    <?php echo LSD_Form::select([
                        'class' => 'lsd-admin-input',
                        'id' => 'lsd_display_options_skin_mosaic_mousewheel_zoom',
                        'name' => 'lsd[display][mosaic][mousewheel_zoom]',
                        'options' => [
                            '0' => esc_html__('Disabled', 'listdom'),
                            '1' => esc_html__('Enabled', 'listdom'),
                        ],
                        'value' => $mosaic['mousewheel_zoom'] ?? '0',
                    ]); ?>
    ...
    <div class="lsd_display_options_skin_mosaic_map_options lsd-settings-group-wrapper lsd-form-group lsd-form-row-map-needed lsd-p-0 lsd-m-0 <?php echo isset($mosaic['map_provider']) && $mosaic['map_provider'] ? '' : 'lsd-util-hide'; ?>">
        ...
        <div class="lsd-settings-fields-wrapper">
                    ...
                    <?php echo LSD_Form::select([
                        ...
                        'options' => [
                            'infowindow' => [
                                ...
                                'attributes' => [
                                    'data-lsd-show' => '#lsd_display_options_skin_mosaic_infowindow_trigger',
                                ],
                            ],
                            'redirect' => [
                                'label' => esc_html__('Redirect to Single Listing Page', 'listdom'),
                                'attributes' => [
                                    'data-lsd-hide' => '#lsd_display_options_skin_mosaic_infowindow_trigger',
                                ],
                            ],
                            'lightbox' => [
            ...
            <div class="lsd-form-row <?php echo $mapobject_onclick === 'infowindow' ? '' : 'lsd-util-hide'; ?>" id="lsd_display_options_skin_mosaic_infowindow_trigger">
                <div class="lsd-col-3"><?php echo LSD_Form::label([
                    'class' => 'lsd-fields-label',
                    'title' => esc_html__('Info Window Trigger', 'listdom'),
                    'for' => 'lsd_display_options_skin_mosaic_infowindow_trigger_select',
                ]); ?></div>
                <div class="lsd-col-7">
                    <?php echo LSD_Form::select([
                        'class' => 'lsd-admin-input',
                        'id' => 'lsd_display_options_skin_mosaic_infowindow_trigger_select',
                        'name' => 'lsd[display][mosaic][mapobject_infowindow_trigger]',
                        'options' => [

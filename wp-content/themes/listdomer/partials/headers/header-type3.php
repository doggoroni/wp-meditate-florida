...
?>
<header role="banner" id="masthead" class="site-header d-flex flex-column flex-md-row site-header-type3">
    <div class="site-branding <?php echo $listdomer_logo_bg ? '' : 'site-branding-no-bg'; ?>">
        <?php
            if (has_custom_logo()) echo LSDR_Theme::logo();
            else
            {
    ...
    <nav class="main-navigation navbar-collapse offcanvas-collapse" role="navigation"
        ...
        <button id="main-navigation-close" aria-label="<?php echo esc_attr__('Navigation Close', 'listdomer'); ?>" class="main-navigation-close">
